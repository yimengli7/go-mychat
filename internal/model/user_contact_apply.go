...
type UserContactApply struct {
	...
	UserId      string    `gorm:"column:user_id;index;type:char(18);not null;comment:申请人id"`
	ContactId   string    `gorm:"column:apply_contact_id;index;type:char(18);not null;comment:被申请人id"`
